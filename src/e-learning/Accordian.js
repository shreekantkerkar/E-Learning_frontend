      ...
      {isOpen && (
        <div>
          {chapters.map((chapter, index) => (
            <div key={index}>
              <div className="flex justify-between items-center px-4 py-2 cursor-pointer bg-gray-200 hover:bg-gray-300">
                ...
                <div className="flex items-center space-x-2">
                  {isLoggedIn && (
                    <>
                      <button className="px-2 py-1 bg-yellow-500 text-white rounded-full hover:bg-yellow-600">
